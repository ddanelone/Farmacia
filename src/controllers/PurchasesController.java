...
public class PurchasesController implements KeyListener, ActionListener, MouseListener {
        ...
        if (e.getSource() == views.btn_add_product_to_buy) {
            ...
            if (getIdSupplier == 0) {
                ...
                if (getIdSupplier != supplier_id) {
                    ...
                    int purchase_id = Integer.parseInt(views.txt_purchase_product_id.getText());
    ...
    private void insertPurchase() {
        double total = Double.parseDouble(views.txt_purchase_product_total_to_pay.getText());
    ...
    public void cleanFieldsPurchases() {
        ...
        views.txt_purchase_product_total_to_pay.setText("");
    }
    ...
    public void calculatePurchase() {
        ...
        for (int i = 0; i < numRow; i++) {
            //Pasar el ídnice de la columna que se sumará
            total = total + Double.parseDouble(String.valueOf(views.purchases_table.getValueAt(i, 4)));
        }
        views.txt_purchase_product_total_to_pay.setText("" + total);
    }
