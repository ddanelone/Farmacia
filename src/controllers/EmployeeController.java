...
public class EmployeeController implements ActionListener, MouseListener, KeyListener {
    ...
    public EmployeeController(Employees employee, EmployeesDao employeeDao, SystemView views) {
        ...
        //Escuchar el mouse en la tabla
        this.views.employees_table.addMouseListener(this);
        //Escuhar el teclado en la caja de búsqueda
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == views.btn_register_employee) {
            ...
            //Recolectar información d elas cajas password
            ...
            //Verificar que las contraseñas están vacías o al menos una
