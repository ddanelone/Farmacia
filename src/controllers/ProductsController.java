...
public class ProductsController implements ActionListener, MouseListener, KeyListener {
    ...
    public ProductsController(Products product, ProductsDao productDao, SystemView view) {
        ...
        this.views = view;
        //Pondemos a escuchar el botón de registro
        this.views.btn_register_product.addActionListener(this);
        //Ponemos a escuchar el boton de actualizar producto
        ...
        //Pondemos a escuchar la tabla
        this.views.products_table.addMouseListener(this);
        //Ponemos a escuchar al botón de buscar
        this.views.txt_search_product.addKeyListener(this);
        //Ponemos a la esucha el panel lateral
