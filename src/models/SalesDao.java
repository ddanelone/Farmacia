...
public class SalesDao {
 ...
 //Regustrar detalles de una venta
...
Timestamp datetime = new Timestamp(new Date().getTime());
 ...
 //Obtener el máximo id de una venta para relacionar la tabla sales y sales_details
  public int saleId() {
 ...
 //Listar el detalle de las ventas realizadas
