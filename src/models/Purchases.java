...
public class Purchases {
    ...
    public Purchases(int id, int code, String product_name, int pruchase_amount, double purchase_price, double purchase_subtotal, double total, String created, String supplier_name_product, String purcharser) {
        this.id = id;
        this.code = code;
        this.product_name = product_name;
        this.purchase_amount = pruchase_amount;
    ...
    public void setPurchase_amount(int pruchase_amount) {
        this.purchase_amount = pruchase_amount;
    }
